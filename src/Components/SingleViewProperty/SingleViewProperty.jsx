...
const SingleViewProperty = () => {
    const singleProperties = useLoaderData();
    const { id } = useParams();
    const property = singleProperties.find(property => property.id === id)
    console.log(property);
    const { image, estate_title, description, price, area, facilities, location, status, segment_name } = property;
    // const { id } = useParams();
    ...
    return (
        <div data-aos="zoom-in">
            <Helmet><title>Single Family details</title></Helmet>
            <div>
...
export default SingleViewProperty;