...
const AboutUs = () => {
  return (
 <div>
     <p data-aos="zoom-in" data-aos-duration="1500" className='text-base lg:text-3xl font-bold   md:w-[700px] mx-auto text-center mt-3 uppercase bg-gradient-to-r from-orange-700 via-blue-500 to-green-400 text-transparent bg-clip-text animate-gradient '>About Us</p>
