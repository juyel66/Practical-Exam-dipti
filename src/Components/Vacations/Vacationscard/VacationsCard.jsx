...
const VacationsCard = ({ item }) => {
    // console.log(item);
    const { image, estate_title, description, segment_name, id5 } = item;
    return (
            ...
            <div className="card h-[500px] w-full  hover:border-3 hover:bg-gray-200 hover:border-green-500 bg-base-100 border-2 border-gray-500 shadow-xl">
                ...
                <div className="card-body">
                    ...
                    <div className="card-actions">
                        <Link to={`/vacationViewProperty/${id5}`} className="w-full" ><button className="btn w-full bg-green-500 text-white text-xl hover:text-black">View Property</button></Link>
                    </div>
                </div>
            </div>
