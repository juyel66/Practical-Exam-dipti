...
<div>
            ...
            <h1 data-aos="fade-down" data-aos-duration="1000" className="lg:text-4xl text-3xl text-center font-bold font-sans bg-gradient-to-r from-primary via-red-900 to-secondary text-transparent bg-clip-text animate-gradient bg-400%" >WELCOME TO OUR JR RESIDENTIAL COMPANY</h1> <br /><br />
            {/* swiper  */}
            ...
            <div className="">
                <h1 className="text-center mt-20 text-4xl font-bold text-green-600 p-3">Meet Our Team</h1>
                <p className="text-center p-3 text-green-500 font-bold">Our expert team is made up of creatives with  <br />technical know-how, strategist who think outside the box, and developers who push innovation </p>
