...
const Navbar = () => {
 ...
 const handleLogout = ()=>{
  ...
  {
    user && 
    <li><NavLink className={({ isActive }) => isActive ? 'btn btn-outline btn-success text-bold text-xl' : 'text-xl font-bold'} to="/UpdateProfile">Update Profile</NavLink></li>
  }
    <li><NavLink className={({ isActive }) => isActive ? 'btn btn-outline btn-success text-bold text-xl' : 'text-xl font-bold'} to="/userProfile">User Profile</NavLink></li>
      ...
      
        {
          user ?
            ...
            <div className="flex gap-2">
              <Link to="/login" className="btn lg:w-[120px] text-white bg-green-500">Login </Link>
