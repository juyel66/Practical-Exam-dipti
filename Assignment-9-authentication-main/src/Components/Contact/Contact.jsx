...
const Contact = () => {
    ...
    return (
        <div>
            ...
            <h1 data-aos="fade-down" data-aos-duration="1000" className="lg:text-4xl mt-16 text-3xl text-center font-bold font-sans bg-gradient-to-r from-primary via-green-500 to-secondary text-transparent bg-clip-text animate-gradient bg-300%">Our Office Location</h1>
            <div className="lg:flex space-y-3 gap-7 mt-5">
                <div>
                    <img className="h-[500px]" src="https://i.ibb.co/TD3zYNL/modern-residential-building-beautiful-recreation-area-modern-residential-building-recreation-area-13.webp" alt="" />
                </div>
                ...
                <div className="card card-compact border-2 border-yellow-500  bg-base-100 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions justify-end">
                            <button className="btn btn bg-yellow-500 w-full text-white text-xl  ">Contact us</button>
                        </div>
                    </div>
                </div>
